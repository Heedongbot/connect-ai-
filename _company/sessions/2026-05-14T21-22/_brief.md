...
## 요약
자율 사이클에서 가장 중요한 작업은 사용자의 지속적 관심 유발과 회사 목표 달성이다. 24시간 운영 중인 한, 최근 의사결정 및 메모리에서 중요할 것으로 보이는 정보를 분석하여 가치 있는 단일 작업을 선택하고 이 작업에 필요한 에이전트들을 분배하여 실행한다.

## 분배
- **🔍 Researcher**: 2026년 5월 상반기 트렌드 및 경쟁사 분석
